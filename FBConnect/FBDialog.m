...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    //line added to make the failure function get called if dialog is dismissed
    [_webView stringByEvaluatingJavaScriptFromString:@"document.getElementById('cancel').onclick = function onclick(event) { document.getElementById('input_redirect_uri').value = 'fbconnect://cancel'; };"];
